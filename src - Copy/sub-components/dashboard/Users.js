...
import { commonQuery, exportAllUsers,uploadBulkSheet } from "@/app/api/user";
  ...
  const ActionMenu = ({ userID, status, userEmail,emailVerify }) => (
    <Dropdown>
      ...
      disabled={Boolean(emailVerify === "Verified")}
        ...
        {status !== "active" && (
          <Dropdown.Item
            onClick={() => handleShowActionPop("active", userID, userEmail)}
            eventKey="4"
          >
            Active
          </Dropdown.Item>
        ...
        {status !== "Approval Required" && (
          <Dropdown.Item
            onClick={() => handleShowActionPop("Approval Required", userID, userEmail)}
            eventKey="5"
          >
            Approval Required
          </Dropdown.Item>
